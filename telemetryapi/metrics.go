...
// ProcessPlatformReport processes the `platform.report` line from Telemetry API and
...
func ProcessPlatformReport(fnARN string, deadlineMs int64, ts time.Time, platformReport TelEvent) ([]byte, error) {
